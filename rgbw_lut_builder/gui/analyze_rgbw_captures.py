...
try:
    from ..paths import DEFAULT_ANALYSIS_OUTPUT_DIR, DEFAULT_CAPTURE_INPUT_DIR
except ImportError:
    _PROJECT_ROOT = Path(__file__).resolve().parents[2]
    DEFAULT_CAPTURE_INPUT_DIR = _PROJECT_ROOT / "patch_captures"
    DEFAULT_ANALYSIS_OUTPUT_DIR = _PROJECT_ROOT / "analysis_outputs"

DEFAULT_INPUT_DIR = DEFAULT_CAPTURE_INPUT_DIR
DEFAULT_OUTPUT_DIR = DEFAULT_ANALYSIS_OUTPUT_DIR
