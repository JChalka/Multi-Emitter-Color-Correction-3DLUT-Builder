...
class SolverSettings:
    ...
    config_dir: Path = Path(__file__).with_name("config")
...
class RGBWLutApp(tk.Tk):
    ...
    def _build_controls(self, parent: ttk.Frame) -> None:
        ...
        self._config_dir_var = tk.StringVar(value=str(getattr(self.settings, "config_dir", Path(__file__).with_name("config"))))
    ...
    def _settings_as_namespace(self) -> Any:
        ...
        ns.config_dir = Path(getattr(ns, "config_dir", Path(__file__).with_name("config")))
    ...
    def _browse_config_dir(self) -> None:
        initial = self._config_dir_var.get() or str(Path(__file__).with_name("config"))
